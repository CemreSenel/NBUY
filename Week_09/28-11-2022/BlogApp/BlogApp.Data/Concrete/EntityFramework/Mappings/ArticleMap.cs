...
namespace BlogApp.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            ...
            //Burada EfCore tarafından default convention yontemı ıle kendılıgınden gerceklesen bazı ayarları el ıle yapıyor olacagız.Bu daha profesyonel surdurulebılir genısletılebılır uygulamalar yapmak ıcın tercıh edılen bır yoldur.
            builder.HasKey(a => a.Id);//PrimaryKey
            builder.Property(a=>a.Id).ValueGeneratedOnAdd();//Identıty eklendıkce bırer bırer artıs

            builder.Property(a => a.Title).IsRequired();//zorunlu varsayılanı true yanı zorunlu
            ...
            //İlk article verilerinın eklenmesı
