    ...
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(u => u.Email)
                .IsRequired()
                .HasMaxLength(50);
                builder.HasIndex(u => u.Email).IsUnique();//benzersiz deger ozelligi aynı email adresi ile kayıt
           ...
           .HasMaxLength(250);
            ...
            builder.HasData(
                new User
                {
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2")//qwe123 sifremızın hashlenmıs halı
                ...
                new User
                {
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a")//123qwe sifremızın hashlenmıs halı
