...
// let urunler = ['ıphone13','ıphone xr','dell x5'];
// let fiyatlar = [15000,35000,45000];
// let renkler = ['gold',' gray','lacivert']
...
// let urun1 = 'Iphone 13,25000,yesıl,true';
// let urunDizi = urun1.split(',');
// console.log(urun1,typeof urun1);
// console.log(urunDizi,typeof urunDizi);
...
console.log('Sonuç: ' + sonuc);
console.log('ikinci Dizi: ' + ikinciDizi);
// console.log('Markalar1:' + markalar1);
