        ...
        gorevListesi.push(
            {
                ...
                'gorevAdi': ilkHarfiBuyut(txtTaskName.value)//odev : her kelımenın ılk harfını buyutecek functıonı yazınız
            }
        );
        displayTasks();
    } else {
...
function removeTask(id) {
    ...
    //alternatif modern java-script yontemleri
    ...
    //Artık gorev listesi dizisinden kacıncı sıradakı elemanın sılınecegını bılıyoruz.deletedId ncı sıradakı elemanı sılecegız
