    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Edit(ProductViewModel productViewModel)
        {
            ...
            if (ModelState.IsValid) 
            {
                ...
                {
                    var selializeProduct = JsonConvert.SerializeObject(productViewModel);
                    StringContent stringContent = new StringContent(selializeProduct, Encoding.UTF8, "application/json");
