...
namespace ShoppingApp.Web.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        private async void SaveOrder(OrderDto orderDto,string userId)
        {
            ...
            order.OrderState = EnumOrderState.Unpaid;//Bunu gecıcı olarak yapıyoruz.Aslında buraya odeme tamamlanmıs halde gelecegız ve buranın Completed olamasını saglayacagız.
