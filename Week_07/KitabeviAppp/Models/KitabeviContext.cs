    ...
    public class KitabeviContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitap>()
                .HasData(
                    new Kitap() {Anasayfa=true, Id = 1, Ad = "İnsanlar", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 1,Ozet="Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus eius ipsam sit officiis debitis nostrum perspiciatis sunt tempora. Ea possimus itaque fugit ipsum recusandae esse animi asperiores incidunt eos est!" },
                    ...
                    new Kitap() { Id = 5, Ad = "Serenad", BasimYili = 2020, SayfaSayisi = 300, KategoriId = 2, YazarId = 9 ,Ozet="Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus eius ipsam sit officiis debitis nostrum perspiciatis sunt tempora. Ea possimus itaque fugit ipsum recusandae esse animi asperiores incidunt eos est!" },
                    new Kitap() { Id = 6, Ad = "19", BasimYili = 2016, SayfaSayisi = 380, KategoriId = 2, YazarId = 6,Ozet="Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus eius ipsam sit officiis debitis nostrum perspiciatis sunt tempora. Ea possimus itaque fugit ipsum recusandae esse animi asperiores incidunt eos est!"  },
