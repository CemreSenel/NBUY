    ...
    $(function () {
        ...
        placeHolderDiv.on('click', '#btnSave', function (event) {
            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                if (isValid) {
                    const newTableRow = `
                                <tr name="${categoryAddAjaxModel.CategoryDto.Categories.Id}">
                    ...
                    <td>
                        <button class="btn btn-warning btn-sm btn-update" data-id="${categoryAddAjaxModel.CategoryDto.Categories.Id}><span class="fas fa-edit text-white"></span></button>
                        <button class="btn btn-danger btn-sm btn-delete" data-id="${categoryAddAjaxModel.CategoryDto.Categories.Id}"><span class="fas fa-minus-circle"></span></button>
                    </td>
                                </tr>
                            `;
                ...
                .done(function (data) {
                    ...
                    if (isValid) {
                        ...
                        if (!categoryUpdateAjaxModel.CategoryDto.Category.IsDeleted) {
                            const newTableRow =
                                `
                     <tr name="${categoryUpdateAjaxModel.CategoryDto.Categories.Id}">
                    ...
                    <td>
                        <button class="btn btn-warning btn-sm btn-update" data-id="${categoryUpdateAjaxModel.CategoryDto.Categories.Id}><span class="fas fa-edit text-white"></span></button>
                        <button class="btn btn-danger btn-sm btn-delete" data-id="${categoryUpdateAjaxModel.CategoryDto.Categories.Id}"><span class="fas fa-minus-circle"></span></button>
                    </td>
                                </tr>
                `;
                            const newTableRowObject = $(newTableRow);
                            ...
                            newTableRowObject.fadeIn(1000);
                            toastr.success(`${categoryUpdate.CategoryDto.Message}`, 'İşlem başarılı!');
                        } else {
