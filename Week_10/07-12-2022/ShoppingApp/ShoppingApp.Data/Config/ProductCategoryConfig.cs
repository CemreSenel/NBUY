...
namespace ShoppingApp.Data.Config
{
    public class ProductCategoryConfig : IEntityTypeConfiguration<ProductCategory>
    {
        ...
        {
            builder.HasKey(pc => new { pc.ProductId, pc.CategoryId });//Burada productId ve categoryId den olusan her bır satırın
            //bır kez daha tekrar etmemesi için Composite Primary Key tanımlaması yaptık.
