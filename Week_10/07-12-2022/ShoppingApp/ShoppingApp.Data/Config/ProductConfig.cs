...
namespace ShoppingApp.Data.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        ...
        {
            builder.HasKey(p => p.Id);//Id yı prımarykey yaptık
            ...
            builder.Property(p => p.DateAdded)
                .HasDefaultValueSql("date('now')");//Sqlite  
                                                   //.HasDefaultValueSql("getdate()");  (Bu sql server ile calısırken kullanma seklımız)
            ...
            builder.HasData(
                ...
                new Product {Id=11,Name="Lenovo K234",Price=19500,
